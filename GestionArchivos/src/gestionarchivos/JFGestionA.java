...
public class JFGestionA extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGuardartexto1 = new javax.swing.JButton();
        ...
        btnAbrirArchivo.setFont(new java.awt.Font("Tw Cen MT", 1, 12)); // NOI18N
        btnAbrirArchivo.setForeground(new java.awt.Color(102, 0, 102));
        ...
        btnGuardartexto1.setFont(new java.awt.Font("Tw Cen MT", 1, 12)); // NOI18N
        btnGuardartexto1.setForeground(new java.awt.Color(102, 0, 102));
        btnGuardartexto1.setText("GUARDAR TEXTO 1");
        btnGuardartexto1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGuardartexto1ActionPerformed(evt);
            }
        });

        btnGuardarTexto.setFont(new java.awt.Font("Tw Cen MT", 1, 12)); // NOI18N
        btnGuardarTexto.setForeground(new java.awt.Color(102, 0, 102));
        btnGuardarTexto.setText("GUARDAR TEXTO 2");
        ...
        btnGuardarTexto1.setFont(new java.awt.Font("Tw Cen MT", 1, 12)); // NOI18N
        btnGuardarTexto1.setForeground(new java.awt.Color(102, 0, 102));
        btnGuardarTexto1.setText("GUARDAR TEXTO 3");
        btnGuardarTexto1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGuardarTexto1ActionPerformed(evt);
            }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnGuardartexto1, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
    ...
    private void btnGuardartexto1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardartexto1ActionPerformed
    ...
    }//GEN-LAST:event_btnGuardartexto1ActionPerformed
    ...
    private void btnGuardarTexto1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarTexto1ActionPerformed
        ...
        if(seleccionado.showDialog(null, "GUARDAR TEXTO") == JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.getName().endsWith("txt")){
                String contenido = jTextArea1.getText();
                String contenido2 = txtAreaTexto.getText();
                String contenido3 = contenido+contenido2;
                String respuesta = gestion.GuardarATexto(archivo, contenido3);
                if(respuesta!=null){
                    JOptionPane.showMessageDialog(null, respuesta);
                }else{
                    JOptionPane.showMessageDialog(null, "Error al guardar texto.");
    ...
    private javax.swing.JButton btnGuardarTexto1;
    private javax.swing.JButton btnGuardartexto1;
